...
%prep
%setup -q -n pyflakes-2.3.1
cd %{_builddir}/pyflakes-2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616608802
...
cp %{_builddir}/pyflakes-2.3.1/LICENSE %{buildroot}/usr/share/package-licenses/pyflakes/200da923b63ba8767fe085a65a35f9c01b5eb867
