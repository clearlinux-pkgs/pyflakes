...
Source0  : https://files.pythonhosted.org/packages/52/f2/5642322bb66a424c5d86c1ff3106260debc4f9677313b895358943d40e2f/pyflakes-2.3.0.tar.gz
...
%prep
%setup -q -n pyflakes-2.3.0
cd %{_builddir}/pyflakes-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615751809
...
cp %{_builddir}/pyflakes-2.3.0/LICENSE %{buildroot}/usr/share/package-licenses/pyflakes/200da923b63ba8767fe085a65a35f9c01b5eb867
